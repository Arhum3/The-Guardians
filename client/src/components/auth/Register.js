    ...
    return (
      <div class="row" style={{paddingLeft:'15px'}}>
        <div class="container col s12" style={{marginTop:'70px', marginLeft:'50px'}}>
          <div className="col s4" style={{marginTop:75, marginLeft:170}}>
          ...
          <div class = "col s3" style={{ marginLeft: '50px', marginTop:'200px'}}>
              <img class="responsive-img" src={regImg} alt="Register"/>
            </div>
        </div>
      </div>
    );
